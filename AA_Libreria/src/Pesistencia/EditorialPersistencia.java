...
//
    ...
    public List<Editorial> listarEditoralCodigo(Integer codigo) throws Exception {
        List<Editorial> editorialCodigo = em.createQuery("SELECT d "
                + " FROM Autor d"
                + " WHERE d.codEditoral = :codigo").
                setParameter("codEditorial", codigo)
                .getResultList();
