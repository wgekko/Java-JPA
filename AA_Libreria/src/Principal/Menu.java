...
public class Menu {
    ...
    MenuAutor menuAutor;
     MenuEditorial menuEdi;
     MenuLibro menuLib;
    public Menu() {
        this.leer = new Scanner(System.in);
        this.menuAutor = new MenuAutor();
        this.menuEdi = new MenuEditorial();
    ...
    public void menu() throws Exception {
        ...
        do {
            System.out.println("------------------------------------------------------------");
            System.out.println(" 1- Gestionar Editorial");
            System.out.println(" 2- Gestionar Autor ");
            System.out.println(" 3- Gestionar Libro ");                 
            ...
            switch (opcion) {
                ...
                case 4:
                    ...
                    break;             
                default:
                    System.out.println("ERROR, la opción digitada no es la correcta ... ");
                    break;
            }
