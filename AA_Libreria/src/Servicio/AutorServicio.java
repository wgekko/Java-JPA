...
public class AutorServicio {
    ...
    AutorPersistencia autorPer;

    public AutorServicio() {
        autorPer = new AutorPersistencia();

    }

    public Autor creaautor(Integer codigo,String nombre, Boolean alta) {
        Autor autornuevo = new Autor();
        try {
            if(codigo == null || codigo <=0){
                throw new Exception("Debe ingresar el codigo correctamente ");                
            }
...
//                throw new Exception("Debe ingresar el codigo correctamente ");                
//            }
            autornuevo.setCodAutor(codigo);
            autornuevo.setNombre(nombre);
            autornuevo.setAlta(Boolean.TRUE);
            autorPer.guardarAutor(autornuevo);
            return autornuevo;
     ...
     public Autor buscarAutorPorNombre(String nombre) throws Exception {
        try {
            ...
            Autor autor = autorPer.buscarAutorPornombre(nombre);
            return autor;
        } catch (Exception e) {
            throw e;
        }
    ...
    public void eliminarautor(String nombre) {
        try {
            ...
            autorPer.eliminarAutornombre(nombre);
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }
    }
    ...
    public void modificarautor(String nombre, String nuevonombre) {
        ...
        try {
            ...
            aux = autorPer.buscarAutorPornombre(nombre);
            aux.setNombre(nuevonombre);
            autorPer.modificarAutor(aux);
